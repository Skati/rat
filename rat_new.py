...
group0 = df.groupby(['object', 'timeStamp'])['eventTime']
group_list = []
...
#     print(group)
# print(group_list)
# group0=group0.nth([0, -1])
# group0.to_excel(
#     writer, sheet_name='group0', index=True, float_format="%.2f")
...
# tukey_res1.to_excel(
#     writer, sheet_name='group statistics after 060620', index=True)

#ttest=ttest_ind(*df.groupby(['object', 'timeStamp'])['eventTime'].apply(lambda x:list(x)))
